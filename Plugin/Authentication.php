<?php
namespace VoolaTech\AdminAutoLogin\Plugin;
...
class Authentication
{
    ...
    /**
     * @var \VoolaTech\AdminAutoLogin\Model\Config\Source\AdminUser
     */
    ...
    public function __construct(
        ...
        \VoolaTech\AdminAutoLogin\Model\Config\Source\AdminUser $adminUserSource
    ) {
        $this->auth = $auth;
